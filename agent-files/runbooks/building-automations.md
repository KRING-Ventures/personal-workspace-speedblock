...
1. **Confirm scope back.** One line: *"So: every weekday at 17:00, you want a list of any commitment due tomorrow — Slack only, no emails to anyone. Right?"* Lock trigger, action, surface, and who (if anyone) it touches **before** building. (This is the *Make instructions followable* habit from `AGENTS.md` → *How you answer*, applied to automations.)
