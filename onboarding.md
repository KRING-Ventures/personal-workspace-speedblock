...
- **4 Commandments walkthrough during the first conversation** — the assistant teaches the user the four working practices (make the agent repeat back your prompt, work in small batches and save as you go, KISS, work on a copy in shared projects) and the must-know vocab. Reference docs: `best-practice.md`, `terms.md`.
